...
class DatabaseSessionManager:
    ...
    def migrate_tables(self):
        ...
        migrations = [
            ...
            ("new_api_services", "name", "VARCHAR(100)"),
            ("new_api_services", "api_url", "VARCHAR(500)"),
            ("new_api_services", "username", "VARCHAR(100)"),
            ("new_api_services", "password", "TEXT"),
            ("new_api_services", "api_key", "TEXT"),
            ("new_api_services", "enabled", "BOOLEAN DEFAULT 1"),
            ("new_api_services", "priority", "INTEGER DEFAULT 0"),
            ("new_api_services", "created_at", "DATETIME"),
            ("new_api_services", "updated_at", "DATETIME"),
            ...
            ("scheduled_registration_jobs", "job_uuid", "VARCHAR(36)"),
            ("scheduled_registration_jobs", "name", "VARCHAR(100)"),
            ("scheduled_registration_jobs", "enabled", "BOOLEAN DEFAULT 1"),
            ("scheduled_registration_jobs", "status", "VARCHAR(20) DEFAULT 'idle'"),
            ("scheduled_registration_jobs", "schedule_type", "VARCHAR(20)"),
            ("scheduled_registration_jobs", "schedule_config", "TEXT"),
            ("scheduled_registration_jobs", "registration_config", "TEXT"),
            ("scheduled_registration_jobs", "timezone", "VARCHAR(50) DEFAULT 'local'"),
            ("scheduled_registration_jobs", "next_run_at", "DATETIME"),
            ("scheduled_registration_jobs", "last_run_at", "DATETIME"),
            ("scheduled_registration_jobs", "last_success_at", "DATETIME"),
            ("scheduled_registration_jobs", "last_error", "TEXT"),
            ("scheduled_registration_jobs", "run_count", "INTEGER DEFAULT 0"),
            ("scheduled_registration_jobs", "consecutive_failures", "INTEGER DEFAULT 0"),
            ("scheduled_registration_jobs", "is_running", "BOOLEAN DEFAULT 0"),
            ("scheduled_registration_jobs", "last_triggered_task_uuid", "VARCHAR(36)"),
            ("scheduled_registration_jobs", "last_triggered_batch_id", "VARCHAR(36)"),
            ("scheduled_registration_jobs", "created_at", "DATETIME"),
            ("scheduled_registration_jobs", "updated_at", "DATETIME"),
        ]
