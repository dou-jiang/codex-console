...
def current_create_email_step(ctx: PipelineContext) -> dict[str, Any]:
...
def current_wait_signup_otp_step(ctx: PipelineContext) -> dict[str, Any]:
...
def current_wait_login_otp_step(ctx: PipelineContext) -> dict[str, Any]:
...
def current_exchange_oauth_token_step(ctx: PipelineContext) -> dict[str, Any]:
...
def build_current_pipeline_definition() -> PipelineDefinition:
    return PipelineDefinition(
        ...
        steps=[
            ...
            StepDefinition("wait_signup_otp", current_wait_signup_otp_step, impl_key="current.wait_signup_otp"),
            ...
            StepDefinition("wait_login_otp", current_wait_login_otp_step, impl_key="current.wait_login_otp"),
            ...
            StepDefinition("exchange_oauth_token", current_exchange_oauth_token_step, impl_key="current.exchange_oauth_token"),
...
def register_current_pipeline() -> PipelineDefinition:
    existing = get_pipeline("current_pipeline")
